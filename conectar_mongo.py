...
# Abaixo a consulta realiza o cadastro de um novo usuario e 
# retorna o id do usuario cadastrado
#usuario_id = db["usuario"].insert_one({"nomeusuario":"jude","senha":"123","nivel":"usuario"}).inserted_id
#print(usuario_id)


# Localizar apenas um usuário no banco dados
