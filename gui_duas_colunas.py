...
class GuiDuasColunas(QWidget):
    ...
    def __init__(self):
        ...
        labelColEsq = QLabel()
        labelColEsq.setStyleSheet("QLabel{background-color:#a69785}")
        labelColEsq.setFixedWidth(800)

        labelColDir = QLabel()
        labelColDir.setStyleSheet("QLabel{background-color:#807462}")
        labelColEsq.setFixedWidth(800)
        ...
        # chamando a função(keyPressEvent) para executar um comando quando está tecla
        # for acionada.
